...
VALUES (1, CURRENT_TIMESTAMP, 1001, 1, 'author1', 1, 10, 'sha001', '버그 수정 PR', 'OPEN', 'https://github.com/test/repo/pull/10', 2, 50, 20, 1, '2024-01-15 10:00:00');
...
VALUES (2, CURRENT_TIMESTAMP, 1002, 1, 'author2', 2, 20, 'sha002', '기능 개발 PR', 'MERGED', 'https://github.com/test/repo/pull/20', 8, 400, 100, 5, '2024-01-10 09:00:00', '2024-01-12 15:00:00', '2024-01-12 15:00:00');

INSERT INTO pull_requests (id, created_at, github_pull_request_id, project_id, user_name, user_id, pull_request_number, head_commit_sha, title, state, link, changed_file_count, addition_count, deletion_count, commit_count, github_created_at, github_merged_at, github_closed_at)
VALUES (3, CURRENT_TIMESTAMP, 1003, 1, 'author1', 1, 30, 'sha003', '두 번째 버그 수정', 'MERGED', 'https://github.com/test/repo/pull/30', 4, 150, 60, 3, '2024-01-20 14:00:00', '2024-01-21 10:00:00', '2024-01-21 10:00:00');
