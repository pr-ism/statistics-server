...
VALUES (1, CURRENT_TIMESTAMP, 1, 'author1', 10, 'Small PR', 'OPEN', 'https://github.com/test/repo/pull/10', 2, 50, 20, 1, '2024-01-10 09:00:00');
...
VALUES (2, CURRENT_TIMESTAMP, 1, 'author2', 20, 'Medium PR', 'MERGED', 'https://github.com/test/repo/pull/20', 5, 180, 50, 3, '2024-01-20 10:00:00', '2024-01-22 15:00:00', '2024-01-22 15:00:00');

-- PR3: 2024-02-15, LARGE (400 + 150 = 550)
INSERT INTO pull_requests (id, created_at, project_id, author_github_id, pull_request_number, title, state, link, changed_file_count, addition_count, deletion_count, commit_count, pull_request_created_at, merged_at, closed_at)
VALUES (3, CURRENT_TIMESTAMP, 1, 'author1', 30, 'Large PR', 'MERGED', 'https://github.com/test/repo/pull/30', 10, 400, 150, 7, '2024-02-15 14:00:00', '2024-02-17 10:00:00', '2024-02-17 10:00:00');

-- PR4: 2024-03-01, EXTRA_LARGE (700 + 300 = 1000)
INSERT INTO pull_requests (id, created_at, project_id, author_github_id, pull_request_number, title, state, link, changed_file_count, addition_count, deletion_count, commit_count, pull_request_created_at, merged_at, closed_at)
VALUES (4, CURRENT_TIMESTAMP, 1, 'author2', 40, 'XL PR', 'MERGED', 'https://github.com/test/repo/pull/40', 22, 700, 300, 14, '2024-03-01 08:00:00', '2024-03-03 12:00:00', '2024-03-03 12:00:00');
