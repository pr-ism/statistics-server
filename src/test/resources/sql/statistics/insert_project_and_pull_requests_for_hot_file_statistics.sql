...
VALUES (1, CURRENT_TIMESTAMP, 1, 'author1', 10, '버그 수정 PR', 'OPEN', 'https://github.com/test/repo/pull/10', 3, 100, 40, 2, '2024-01-15 10:00:00');
...
VALUES (2, CURRENT_TIMESTAMP, 1, 'author2', 20, '기능 개발 PR', 'MERGED', 'https://github.com/test/repo/pull/20', 4, 200, 60, 4, '2024-01-20 09:00:00', '2024-01-22 15:00:00', '2024-01-22 15:00:00');

INSERT INTO pull_requests (id, created_at, project_id, author_github_id, pull_request_number, title, state, link, changed_file_count, addition_count, deletion_count, commit_count, pull_request_created_at, merged_at, closed_at)
VALUES (3, CURRENT_TIMESTAMP, 1, 'author1', 30, '리팩토링 PR', 'MERGED', 'https://github.com/test/repo/pull/30', 2, 150, 80, 3, '2024-02-01 14:00:00', '2024-02-02 10:00:00', '2024-02-02 10:00:00');
