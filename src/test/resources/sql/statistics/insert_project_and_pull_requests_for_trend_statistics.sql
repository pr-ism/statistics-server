...
VALUES (1, CURRENT_TIMESTAMP, 1001, 1, 'author1', 1, 10, 'sha001', 'Feature A', 'OPEN', 'https://github.com/test/repo/pull/10', 3, 100, 50, 2, '2024-01-02 10:00:00');

-- PR2: 2024-01-05 (금), additions=200, deletions=100 → 변경량 300
INSERT INTO pull_requests (id, created_at, github_pull_request_id, project_id, user_name, user_id, pull_request_number, head_commit_sha, title, state, link, changed_file_count, addition_count, deletion_count, commit_count, github_created_at)
VALUES (2, CURRENT_TIMESTAMP, 1002, 1, 'author2', 2, 20, 'sha002', 'Feature B', 'OPEN', 'https://github.com/test/repo/pull/20', 5, 200, 100, 3, '2024-01-05 14:00:00');
...
VALUES (3, CURRENT_TIMESTAMP, 1003, 1, 'author1', 1, 30, 'sha003', 'Bugfix C', 'MERGED', 'https://github.com/test/repo/pull/30', 2, 50, 30, 1, '2024-01-15 09:00:00', '2024-01-16 10:00:00', '2024-01-16 10:00:00');

-- PR4: 2024-01-17 (수), additions=400, deletions=200 → 변경량 600
INSERT INTO pull_requests (id, created_at, github_pull_request_id, project_id, user_name, user_id, pull_request_number, head_commit_sha, title, state, link, changed_file_count, addition_count, deletion_count, commit_count, github_created_at, github_merged_at, github_closed_at)
VALUES (4, CURRENT_TIMESTAMP, 1004, 1, 'author2', 2, 40, 'sha004', 'Feature D', 'MERGED', 'https://github.com/test/repo/pull/40', 8, 400, 200, 5, '2024-01-17 11:00:00', '2024-01-18 15:00:00', '2024-01-18 15:00:00');

-- PR5: 2024-01-19 (금), additions=120, deletions=0 → 변경량 120
INSERT INTO pull_requests (id, created_at, github_pull_request_id, project_id, user_name, user_id, pull_request_number, head_commit_sha, title, state, link, changed_file_count, addition_count, deletion_count, commit_count, github_created_at, github_merged_at, github_closed_at)
VALUES (5, CURRENT_TIMESTAMP, 1005, 1, 'author1', 1, 50, 'sha005', 'Feature E', 'MERGED', 'https://github.com/test/repo/pull/50', 4, 120, 0, 2, '2024-01-19 16:00:00', '2024-01-20 10:00:00', '2024-01-20 10:00:00');

-- 2024-01-22 주 (월요일 2024-01-22): 1건
-- PR6: 2024-01-24 (수), additions=500, deletions=500 → 변경량 1000
INSERT INTO pull_requests (id, created_at, github_pull_request_id, project_id, user_name, user_id, pull_request_number, head_commit_sha, title, state, link, changed_file_count, addition_count, deletion_count, commit_count, github_created_at, github_merged_at, github_closed_at)
VALUES (6, CURRENT_TIMESTAMP, 1006, 1, 'author2', 2, 60, 'sha006', 'Refactor F', 'MERGED', 'https://github.com/test/repo/pull/60', 15, 500, 500, 8, '2024-01-24 08:00:00', '2024-01-26 12:00:00', '2024-01-26 12:00:00');
