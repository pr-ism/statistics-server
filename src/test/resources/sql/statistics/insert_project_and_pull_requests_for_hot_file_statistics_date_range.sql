...
VALUES (1, CURRENT_TIMESTAMP, 1, 'author1', 10, '1월 초 PR', 'MERGED', 'https://github.com/test/repo/pull/10', 2, 100, 40, 2, '2024-01-10 09:00:00', '2024-01-12 15:00:00', '2024-01-12 15:00:00');
...
VALUES (2, CURRENT_TIMESTAMP, 1, 'author2', 20, '1월 중순 PR', 'OPEN', 'https://github.com/test/repo/pull/20', 3, 150, 50, 3, '2024-01-20 10:00:00');

-- PR3: 2024-02-15
INSERT INTO pull_requests (id, created_at, project_id, author_github_id, pull_request_number, title, state, link, changed_file_count, addition_count, deletion_count, commit_count, pull_request_created_at, merged_at, closed_at)
VALUES (3, CURRENT_TIMESTAMP, 1, 'author1', 30, '2월 PR', 'MERGED', 'https://github.com/test/repo/pull/30', 2, 200, 80, 4, '2024-02-15 14:00:00', '2024-02-16 10:00:00', '2024-02-16 10:00:00');

-- PR4: 2024-03-01
INSERT INTO pull_requests (id, created_at, project_id, author_github_id, pull_request_number, title, state, link, changed_file_count, addition_count, deletion_count, commit_count, pull_request_created_at, merged_at, closed_at)
VALUES (4, CURRENT_TIMESTAMP, 1, 'author2', 40, '3월 PR', 'MERGED', 'https://github.com/test/repo/pull/40', 2, 120, 60, 2, '2024-03-01 08:00:00', '2024-03-02 12:00:00', '2024-03-02 12:00:00');
