...
INSERT INTO review_comments (id, created_at, review_id, github_comment_id, github_review_id, body, path, start_line, end_line, side, commit_sha, parent_comment_id, author_mention, author_github_uid, github_created_at, github_updated_at, deleted)
