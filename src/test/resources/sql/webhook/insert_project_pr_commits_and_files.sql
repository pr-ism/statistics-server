...
INSERT INTO commits (pull_request_id, commit_sha, committed_at, created_at)
VALUES (1, 'sha1', '2024-01-15 18:00:00', CURRENT_TIMESTAMP),
       (1, 'sha2', '2024-01-15 18:30:00', CURRENT_TIMESTAMP);

INSERT INTO pull_request_files (pull_request_id, file_name, change_type, additions, deletions, created_at)
VALUES (1, 'src/main/java/OldFile.java', 'MODIFIED', 50, 30, CURRENT_TIMESTAMP),
       (1, 'src/main/java/OldFile2.java', 'ADDED', 50, 20, CURRENT_TIMESTAMP);
