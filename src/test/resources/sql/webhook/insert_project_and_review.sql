...
INSERT INTO reviews (id, created_at, github_pull_request_id, github_review_id, user_name, user_id, review_state, head_commit_sha, comment_count, github_submitted_at)
