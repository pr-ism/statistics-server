...
VALUES (1, CURRENT_TIMESTAMP, 1001, 1, 'testuser', 1, 123, 'abc123', '테스트 PR', 'OPEN', 'https://github.com/test/repo/pull/123', 5, 100, 50, 3, CURRENT_TIMESTAMP);
...
VALUES (1, CURRENT_TIMESTAMP, 1001, 1, 'abc123', 'bug', CURRENT_TIMESTAMP);
