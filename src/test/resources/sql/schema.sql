...
DROP TABLE IF EXISTS pull_request_opened_size_metrics;
...
CREATE TABLE IF NOT EXISTS review_comments (
    ...
    author_mention VARCHAR(255) NOT NULL,
    author_github_uid BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS pull_request_opened_size_metrics (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    created_at TIMESTAMP NOT NULL,
    updated_at TIMESTAMP NOT NULL,
    pull_request_id BIGINT NOT NULL,
    size_score DECIMAL(19, 2) NOT NULL,
    size_grade VARCHAR(10) NOT NULL,
    changed_file_count INT NOT NULL,
    added_file_count INT NOT NULL,
    modified_file_count INT NOT NULL,
    removed_file_count INT NOT NULL,
    renamed_file_count INT NOT NULL
);
