DROP TABLE IF EXISTS collect_inbox;
...
DROP TABLE IF EXISTS pull_request_bottlenecks;
...
CREATE TABLE IF NOT EXISTS pull_request_bottlenecks (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    created_at TIMESTAMP NOT NULL,
    updated_at TIMESTAMP NOT NULL,
    pull_request_id BIGINT NOT NULL,
    ...
    last_approve_at TIMESTAMP,
    CONSTRAINT uq_pull_request_bottlenecks_pr_id UNIQUE (pull_request_id)
);
...
CREATE TABLE IF NOT EXISTS collect_inbox (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    created_at TIMESTAMP NOT NULL,
    updated_at TIMESTAMP NOT NULL,
