...
class PullRequestSizeGradeTest {
    ...
    void 커스텀_임계값으로_등급을_분류한다() {
        ...
        // when & then
        assertThat(PullRequestSizeGrade.classifyWithThresholds(3, xsThreshold, sThreshold, mThreshold, lThreshold))
                .isEqualTo(PullRequestSizeGrade.XS);
        assertThat(PullRequestSizeGrade.classifyWithThresholds(10, xsThreshold, sThreshold, mThreshold, lThreshold))
                .isEqualTo(PullRequestSizeGrade.S);
        assertThat(PullRequestSizeGrade.classifyWithThresholds(30, xsThreshold, sThreshold, mThreshold, lThreshold))
                .isEqualTo(PullRequestSizeGrade.M);
        assertThat(PullRequestSizeGrade.classifyWithThresholds(80, xsThreshold, sThreshold, mThreshold, lThreshold))
                .isEqualTo(PullRequestSizeGrade.L);
        assertThat(PullRequestSizeGrade.classifyWithThresholds(150, xsThreshold, sThreshold, mThreshold, lThreshold))
